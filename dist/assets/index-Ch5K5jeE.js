import{aA as p,aB as u,aw as f,aC as b,aD as d}from"./index-xeh6oSzU.js";import{n as g,r as m,c as w}from"./if-defined-DlTid8OG.js";import{T as l}from"./index-BWKrlHFf.js";const C={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=i[0]||0,r=i[1]||0,t=e[0]||0,s=e[1]||0;return o<n?t:o>r?s:(s-t)/(r-n)*(o-n)+t}},v=p`
  :host {
    width: 100%;
    display: block;
  }
...
//# sourceMappingURL=index-Ch5K5jeE.js.map
