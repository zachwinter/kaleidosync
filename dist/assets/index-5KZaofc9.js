import{b3 as g,b4 as w,b9 as m,ba as f,aA as v,aB as b,aD as x}from"./index-DmvewjL6.js";import{r as u,c as h}from"./if-defined-6N-AQws6.js";const e=w({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return f(e,()=>o(e))},subscribeKey(o,t){return m(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=g(y),R=v`
  :host {
    pointer-events: none;
  }
...
//# sourceMappingURL=index-5KZaofc9.js.map
