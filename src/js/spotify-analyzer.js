...
class SpotifyAnalyzer {
  ...
  getCurrentTrack(callback) {
    ...
    GetJSON(this.endpoints.nowPlaying, (response) => {
  ...
  getTrackData(callback) {
    ...
    GetJSON(this.endpoints.trackFeatures + '/' + this.currentTrack.item.id, (response) => {
    ...
    GetJSON(this.endpoints.trackAnalysis + '/' + this.currentTrack.item.id, (response) => {
